...
from agent import ModelBasedAgent, SearchAgent
...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None):
        ...
        trap_count = min(len(available_positions), max(1, num_food // 2))
        self.toxic_traps = set(random.sample(sorted(available_positions), trap_count))
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.env.toxic_traps:
            ...
            self.canvas.create_polygon(
                x1, y1 + self.cell_size * 0.35,
                x1 + self.cell_size * 0.5, y1,
                x1 + self.cell_size * 0.9, y1 + self.cell_size * 0.35,
                x1 + self.cell_size * 0.7, y1 + self.cell_size * 0.9,
                x1 + self.cell_size * 0.3, y1 + self.cell_size * 0.9,
